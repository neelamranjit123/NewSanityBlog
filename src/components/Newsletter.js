...
export default function Newsletter() {
  return (
    <>
      <section className="py-20 bg-gradient-to-r from-indigo-600 to-slate-800">
        <div className="max-w-4xl mx-auto grid grid-cols-1 gap-8 text-center md:text-left md:grid-cols-2 md:gap-16
